...
### 1️⃣ واجهة الرفع
عند الدخول إلى صفحة المنتجات، ستجد خيار رفع ملف Excel واختيار نوع البيانات (الاسم أو SKU) وتحديد رقم العمود.
<p align="center">
  <img src="12.png" width="800" alt="واجهة رفع ملف الإكسيل">
</p>

### 2️⃣ معاينة المنتجات قبل الحذف
